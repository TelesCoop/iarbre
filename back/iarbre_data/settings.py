...
# For macOS/Windows users, we need to set the GDAL_LIBRARY_PATH and GEOS_LIBRARY_PATH to the path of the libraries
...
PDF_EXPORT_FRONTEND_URL = config.getstr("pdf_export.frontend_url", "http://localhost:4173")
