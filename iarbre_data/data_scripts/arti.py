...
def computeData(df):
    ...
    strateArtiDF = df.copy()
    strateArtiDF = strateArtiDF[strateArtiDF.gl_2015 == 15]

    # Clean data & explode
    currentGeoSerie = strateArtiDF.loc[:, "geometry"]
...
if __name__ == "__main__":
    # Init timer
    subTimer = startTimerLog("EVA Espaces artificialisés subscript process")
