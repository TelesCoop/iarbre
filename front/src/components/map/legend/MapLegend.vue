...
<template>
  <div class="z-3 absolute top-4 right-4 flex flex-col items-center card">
    <div class="font-accent text-base font-bold mb-2">
      <template v-if="mapStore.selectedDataType === DataType.PLANTABILITY"> Plantabilité </template>
      <template v-else-if="mapStore.selectedDataType === DataType.LOCAL_CLIMATE_ZONES">
