...
<template>
  <div
    class="bg-white rounded-lg px-3 py-2 flex items-center justify-center gap-2 border border-gray-200 text-xs h-10"
    style="width: 240px"
  >
    <button
      class="cursor-pointer font-sans flex items-center gap-1 hover:text-primary-500 transition-colors"
